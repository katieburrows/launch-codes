$(document).ready(function () {
    ...
    $("#submitBtn").on("click", function(event){
        ...
        //Grabbing the start date value from the form with jQuery and putting that inside of moment() while also clarifying the date-type moment.js should expect, then formatting that all into unix time.
    ...
    database.ref().on("child_added", function(childSnapshot){
        ...
        //Telling moment.js that this isn't an ordinary date, but actually a unix timestamp, then formatting that into the desired date format.
